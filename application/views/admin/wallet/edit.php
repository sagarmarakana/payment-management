                        ...
                        <div class="row">
                                        ...
                                        <?php
                                            if($accounts){
                                                foreach ($accounts as $key => $account) {
                                                    $selected = $wallet->account_id == $account->id ? 'selected' : '';
                                                    echo '<option value="'.$account->id.'" '.$selected.'>'.$account->bank_name .' - '.$account->owner_name .'</option>';
                                                }
                                            }
                                        ?>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="wallet_type" class="form-control" value="<?= $wallet->wallet_type ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Internal Name</label>
                                    <input type="text" name="internal_name" class="form-control" value="<?= $wallet->internal_name ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="bhim_upi_id" class="form-control" value="<?= $wallet->bhim_upi_id ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="bhim_upi_name" class="form-control" value="<?= $wallet->bhim_upi_name ?>">
