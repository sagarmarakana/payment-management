        ...
        <div class="page-header">
            ...
            <div class="mt-3 mt-lg-0">
                <div class="d-flex align-items-center flex-wrap text-nowrap">
                    <a href="<?=base_url('admin/wallet/add/');?>" class="btn btn-success btn-icon-text mr-2 d-none d-md-block"><i class="fe fe-plus"></i>Add Wallet</a>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        oTable = $('#banks').dataTable({
            ...
            'sAjaxSource': "<?=site_url('admin/wallet/getWallets/')?>",
