...
<body style="margin:0;padding:0;font-family: Arial, Helvetica, sans-serif;font-weight: 400;padding:0 !important; margin:0 !important; display:block !important; min-width:100% !important; width:100% !important; background:#ffffff; color: #35393a; -webkit-text-size-adjust:none; mso-cellspacing:0px; mso-padding-alt:0px 0px 0px 0px" data-gr-c-s-loaded="true">
    <table width="800" border="0" cellspacing="0" cellpadding="0" class="maintablewrap" style="background-color:#6658dd;margin: 0 auto;padding: 60px 100px;">
        <tbody>
            <tr>
                <td>
                                ...
                                <td>
                                    <table width="100%" border="0" cellspacing="0" align="left" valign="top" cellpadding="0" class="">
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <center><img src="<?php echo base_url('assets/images/brand/logo.png'); ?>" height="40px" alt="" /></center>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td align="center"><h1 style="margin: 0;color: #6658dd;font-size: 24px; mso-line-height-rule:exactly;">Forgot Password</h1></td>
                                            </tr>
                                            <tr>
                                    ...
                                    <table width="249" border="0" cellspacing="0" align="center" valign="top" cellpadding="0" class="">
                                        <tbody>
                                            <tr>
                                                <td style="border-radius: 2px;" bgcolor="#6658dd"><a href="<?php echo base_url('auth/reset_password/' . $forgotten); ?>" style="padding: 15px 25px;border-radius: 5px;font-size: 16px; color: #ffffff;text-decoration: none;font-weight:bold;display: block;text-align: center;">Reset Password</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <table width="100%" border="0" cellspacing="0" align="left" valign="top" cellpadding="0" class="">
